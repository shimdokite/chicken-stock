  ...
  return (
    <div className="bg-zinc-300 p-8">
      ...
      <div className="mb-5 flex flex-wrap items-start gap-4">
        <Popover className="h-42.5 w-95 px-9.75 pt-7.75 pb-8.5">
          <div className="flex items-center gap-4.5">
            ...
            <span className="text-xl font-semibold text-zinc-950">김현수</span>
          </div>
        ...
        <Popover className="flex h-17 w-95 items-center justify-center">
          <button
      ...
      <Popover className="h-42.5 w-162.5 px-3 pt-2">
        <Input
          aria-label="최근 검색"
